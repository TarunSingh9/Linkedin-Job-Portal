...
const UpdateJob = () => {
    const {id} = useParams();
    //console.log(id)
     const {_id, companyName, jobTitle, companyLogo, minPrice, maxPrice, salaryType, jobLocation, postingDate, experienceLevel
  ...
  return (
    ...
    <div className='bg-[#FAFAFA] py-10 px-4 lg:px-16'>
      ...
      <div className="lg:w-1/2 w-full">
            ...
            <input 
             type="url" 
             placeholder="Paste your logo URL: https://weshare.com/img1"
        ...
        <div className="lg:w-1/2 w-full">
            ...
            <select
             {...register("employmentType")} className="create-job-input">
